...
## Description
Educational project that focuses on AWS services for Data Engineering. A full ETL pipeline that takes olympics data from the RapidAPI to SQL queries on top of a S3 bucket using Athena.  
